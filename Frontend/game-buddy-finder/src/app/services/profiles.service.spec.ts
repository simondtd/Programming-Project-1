...
describe('ProfilesService', () => {
  ...
  it('Profile should not be valid, firstnameis 0', () => {
    let profile = new Profile(1, null, "Fofana", "AdamaF", "123", "123", "adama@gmail.com", "Oceania", "", "1");
    expect(service.validateUser(profile)).toBeFalse();
  });
  it('Profile should not be valid, lastname is 0', () => {
    let profile = new Profile(1, "Adama", null, "AdamaF", "123", "123", "adama@gmail.com", "Oceania", "", "1");
    expect(service.validateUser(profile)).toBeFalse();
  });
  it('Profile should not be valid, password is 0', () => {
    let profile = new Profile(1, "Adama", "Fofana", "AdamaF", null, "123", "adama@gmail.com", "Oceania", "", "1");
    expect(service.validateUser(profile)).toBeFalse();
  });
  it('Profile should not be valid, re-password is 0', () => {
    let profile = new Profile(1, "Adama", "Fofaa", "AdamaF", "123", null, "adama@gmail.com", "Oceania", "", "1");
    expect(service.validateUser(profile)).toBeFalse();
  });
  it('Profile should not be valid, email  is 0', () => {
    let profile = new Profile(1, "Adama", "Fofana", "AdamaF", "123", "123", null, "Oceania", "", "1");
    expect(service.validateUser(profile)).toBeFalse();
  });
